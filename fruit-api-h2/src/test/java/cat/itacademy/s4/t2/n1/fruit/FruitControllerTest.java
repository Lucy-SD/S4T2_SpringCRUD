...
class FruitControllerTest {
    ...
    @Test
    void createFruit_returns400_whenNameIsBlank() {
        String jsonFruit = "{\"name\":\"\",\"weight\":22.22}";
    ...
    @Test
    void createFruit_returns400_whenNameIsNull() {
        String jsonFruit = "{\"weight\":22.22}";
    ...
    @Test
    void createFruit_returns400_whenNameIsOnlySpaces() {
        String jsonFruit = "{\"name\":\"   \",\"weight\":22.22}";
    ...
    @Test
    void createFruit_returns400_whenWeightIsNegative() {
        String jsonFruit = "{\"name\":\"Banana\",\"weight\":-22.22}";
    ...
    @Test
    void createFruit_returns400_whenWeightIsZero() {
        String jsonFruit = "{\"name\":\"Banana\",\"weight\":0}";
    ...
    void getFruitById_returnsCorrectFruit() {
        ...
        assertThatNoException().isThrownBy(() ->
                mockMvc.perform(get("/fruits/{id}", fruit.getId()))
                        .andExpect(status().isOk())
                        .andExpect(jsonPath("$.id", is(fruit.getId().toString())))
                        .andExpect(jsonPath("$.name", is("Banana")))
                        .andExpect(jsonPath("$.weight", is(22.22)))
        );
    }
    ...
    void updateFruit_returnsUpdatedFruit_whenExists() {
        ...
        assertThatNoException().isThrownBy(() ->
                mockMvc.perform(put("/fruits/{id}", savedFruit.getId())
                        ...
                        .andExpect(status().isOk())
                        .andExpect(jsonPath("$.id", is(savedFruit.getId().toString())))
